  ...
  return (
    <div className={className}>
      ...
      >
        <div className="input-group justify-end rounded-none">
          <input
            ...
            placeholder="Search…"
            className={cn(
              "input input-bordered w-full  rounded-none border-none bg-black/75 text-white",
              {
                hidden: !isTouched,
                flex: isTouched,
              }
      ...
      {suggestedCharacterList.length > 0 && (
        <ul
          id="suggestedList"
          className="menu bg-base-100 w-full  absolute z-10 h-screen flex flex-col bg-black/75 text-white"
          onClick={handleClick}
        >
